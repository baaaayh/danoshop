...
function FindPass() {
    ...
    const validateUser = async () => {
        ...
        if (userInfo.token && response.data.success) {
            navigate('/member/modify', { state: { title: ['회원 정보 수정'] } });
        } else {
            setPassword('');
        ...
        <SubContentsXsmall>
            ...
            <div className="input-form">
                <ul>
                    ...
                    <li>
                        <p>이메일로 찾기</p>
                        <input type="password" value={password} placeholder="비밀번호 입력" onChange={handleInput} />
                    </li>
                </ul>
                <div className="input-form__button">
                    <button type="button" className="btn btn-square btn-square--black" onClick={validateUser}>
