        ...
        <>
          ...
          <div className={styles["cart"]}>
            <div className={styles["cart__view"]}>
              <div className={styles["cart__title"]} ref={cartTitle}>
                <button type="button" onClick={toggleList}>
                  <h2>장바구니 상품</h2>
                </button>
              </div>
              <div className={styles["cart__contents"]} ref={cartContents}>
                          ...
                          <div className={styles["cart__container"]}>
                            <div className={styles["cart__chk"]}>
                              <input
                                type="checkbox"
                                checked={
                                  checkedOptions[`${option.key}`] || false
                                }
                                value={option.key}
                                onChange={() =>
                                  handleCheckbox(item.id, option.key)
                                }
                              />
                            </div>
                            <div className={styles["cart__info"]}>
                              ...
                              <div className={styles["cart__button"]}>
                                <button
                                  ...
                                  onClick={() =>
                                    addWishListItem(item.id, option.key)
                                  }
                                >
                                ...
                                <button
                                  ...
                                  onClick={() => goToPayment(option.key)}
                                >
                                  <span className="btn-square__text">
                                    주문하기
                                  </span>
            ...
            <div className={styles["cart__right"]}>
              <div className={styles["cart__calc"]}>
                ...
                <div className={styles["cart__total"]}>
                  <b>결제예정금액</b>
                  <div>
                    <strong>{`${(totalPrice + 3500).toLocaleString()}`}</strong>{" "}
                    원
                  </div>
                </div>
              </div>
          ...
          <div className={styles["calculate"]}>
            ...
            <ul>
              <li>
                상품구매금액 {totalPrice.toLocaleString()} + 배송비 {"3,500"}
              </li>
              <li>합계 : {(totalPrice + 3500).toLocaleString()}원</li>
            </ul>
          </div>
          <div className="select-button">
            <ul>
              <li>
                ...
                >
                  <span className="btn-square__text">전체선택</span>
                </button>
              </li>
              <li>
                <button
