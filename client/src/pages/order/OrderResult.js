            ...
            <div className="order__box">
              <div className="order__top">
                <div className="order__figure">
                  <img src="/images/icons/icon_bag.png" alt="" />
                </div>
                <strong>
                  고객님의 주문이
                  <br />
              ...
              <div className="order__summary">
                <ul>
                  ...
                  <li>
                    <span>결제금액</span>
                    <strong>{orderInfo?.totalPrice?.toLocaleString()}원</strong>
                  </li>
                </ul>
              </div>
              <div className="order__link">
                <Link to="/">
                  <img src="/images/sub/dano_banner.png" alt="" />
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="order__content">
              <ul>
                ...
                <li>
                  <span>주소</span>
                  <p>
                    {String(orderInfo?.userInfo?.defaultAddress) +
                      String(orderInfo?.userInfo?.subAddress)}
                  </p>
                </li>
                <li>
                  <span>연락처</span>
                  <p>
                    {String(orderInfo?.userInfo?.phone1) +
                      String(orderInfo?.userInfo?.phone2) +
            ...
            <div className="order__content">
              {orderInfo?.items?.map((item) => {
                return item.options.map((option) => {
                  return (
                    <div className="order__product" key={option.key}>
                      ...
                      <div className="order__desc">
                        ...
                        <ul>
                          <li>{option.value.quantity}개</li>
                          <li>
                            상품구매금액:{" "}
                            {(
                              Number(item.data.price) +
                              Number(option.value.price)
                            ).toLocaleString()}
                            원
                          </li>
                          <li>기본배송</li>
          ...
          <div className="order__box order__box--pb20">
            ...
            <div className="order__content order__content--nobd order__content--between">
              ...
              <div className="order__pay">
                <strong>결제금액</strong>
                <b>{(orderInfo?.totalPrice + 3500).toLocaleString()}원</b>
              </div>
            </div>
          </div>
          <div className="order__box">
          ...
          <ul>
            <li>
              <Link
                ...
                state={{ title: ["주문조회"] }}
              >
                <span className="btn btn-square__text">주문확인하기</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                <span className="btn btn-square__text">쇼핑계속하기</span>
              </Link>
            </li>
          </ul>
        </div>
