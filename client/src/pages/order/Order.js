      ...
      if (e.target.name === "phone2") {
        if (value.length < 3) {
          setPhoneMsg({
            ...phoneMsg,
            phone2:
              "휴대전화 번호의 가운데 자리는 최소 3자리 이상 입력해야 합니다.",
          });
        }
        ...
        if (value.length > 4) {
          setPhoneMsg({
            ...phoneMsg,
            phone2:
              "휴대전화 번호의 가운데 자리는 최대 4자리까지 입력 가능합니다.",
          });
        }
      }
      if (e.target.name === "phone3") {
        ...
        if (value.length > 4) {
          setPhoneMsg({
            ...phoneMsg,
            phone3:
              "휴대전화 번호의 마지막 자리는 최대 4자리까지 입력 가능합니다.",
          });
          return;
        }
      }
                  ...
                  <div className="form">
                    ...
                    <div className="form__row form__row--vertical">
                      ...
                      <div className="form__content ">
                        ...
                        <p className="red-text">{phoneMsg.phone1}</p>
                        <p className="red-text">{phoneMsg.phone2}</p>
                        <p className="red-text">{phoneMsg.phone3}</p>
                      </div>
                    </div>
                    <div className="form__row">
                  ...
                  <div className="form__row">
                    ...
                    <div className="form__content">
                      <input
                        ...
                        value={inputValue.confirmNonMemberPW}
                        onChange={handleInputChange}
                      />
                    </div>
                  </div>
                              ...
                              <div className="order__item">
                                ...
                                <div className="order__desc">
                                  ...
                                  <div className="order__price">{`${
                                    (Number(cartItem.data.price) +
                                      Number(orderOption.value.price)) *
                                    orderOption.value.quantity
                                  }원`}</div>
                                </div>
                                <button
                                  type="button"
                ...
                <li>
                  <label htmlFor="personalAgree">
                    <input
                      ...
                      id="personalAgree"
                      name="personalAgree"
                      checked={checkboxValue.personalAgree}
                      onChange={handleCheck}
                    />
                    [필수] 개인정보 수집 및 이용 동의
                  </label>
