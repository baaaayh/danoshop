          ...
          selectedOptions.forEach((selectedOption) => {
            ...
            if (existingOption) {
              selectedOption.value = {
                ...selectedOption.value,
                quantity:
                  selectedOption.value.quantity + existingOption.value.quantity,
              };
            }
          });
        }
        ...
        <div className={styles["detail-view__top"]}>
          ...
          <div className={styles["detail-view__info"]}>
            ...
            <div className={styles["detail-view__list"]}>
              <ul>
                <li>
                  <span className={styles["detail-view__tit"]}>
                    상품요약정보
                  </span>
                  <div>{summary}</div>
                </li>
                ...
                <div className={styles["detail-view__delivery"]}>
                  ...
                  <div>
                    <ul>
                      ...
                      <li>
                        새벽배송 : 지금 주문하면{" "}
                        <strong>9월 24일(화) 오전 7시 전</strong> 도착
                      </li>
                      <li>
                        택배배송 : 지금 주문하면{" "}
                        <strong>9월 23일(월) 출고</strong>
                      </li>
                    </ul>
                  </div>
                </div>
