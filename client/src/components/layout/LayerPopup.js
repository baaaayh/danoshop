...
const LayerPopup = forwardRef(({ closeLayerPopup, isActive }, ref) => {
    return (
        <div className={`${styles['layer-popup']} ${isActive ? styles.active : ''}`} ref={ref}>
            ...
            <div className={styles['layer-popup__button']}>
                <button type="button" className="btn btn-square" onClick={closeLayerPopup}>
                    <span className="btn-square__text">계속 쇼핑하기</span>
                </button>
                <Link to="/order/cart" className="btn btn-square btn-square--black">
