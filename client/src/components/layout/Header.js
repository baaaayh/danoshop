  ...
  useEffect(() => {
    toggleButtons.current.forEach((button) => {
      button.addEventListener("click", function (e) {
        ...
        const sc = this.closest("li").querySelector(".depth2").scrollHeight;
        ...
        <div className="header__inner">
          <div className="header__nav">
            <ul className="menu-nav">
              ...
              {loggedIn === "member" && (
                <li>
                  <Link to="/mypage/dashboard" state={{ title: ["마이쇼핑"] }}>
                    마이페이지
                  </Link>
                </li>
              )}
                ...
                <ul>
                  ...
                  <li>
                    <button
                      ...
                      ref={(el) => (openSearchForm.current[1] = el)}
                    ></button>
                  </li>
                </ul>
              </div>
                ...
                <ul>
                  ...
                  <li>
                    <button
                      type="button"
                      className="btn btn-search"
                      ref={(el) => (openSearchForm.current[0] = el)}
                    >
                      검색
                    </button>
                  </li>
                ...
                <ul>
                  {menuList &&
                    menuList?.menu?.map((item, index) => (
                      <li
                        key={index}
                        ref={(el) => (hoverMenu.current[index] = el)}
                      >
                        <Link
      ...
      <aside className="mob-menu" ref={mobileMenu}>
        <div className="mob-menu__inner">
          ...
          <div className="mob-menu__top">
            <ul>
              <li>
                <Link to="/member/join" state={{ title: ["회원가입"] }}>
                  회원가입
                </Link>
              </li>
              <li>
                  ...
                  <li key={index}>
                    {item.depth2.length > 0 ? (
                      <button
                        type="button"
                        className="depth1"
                        ref={(el) => (toggleButtons.current[index] = el)}
                      >
