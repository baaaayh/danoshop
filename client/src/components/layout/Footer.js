              ...
              >
                <div className={styles.footer__box}>
                  ...
                  <ul>
                    ...
                    <li>
                      <span>CS운영시간</span>
                      <div>9시 ~ 16시 (점심 시간 12시 30분 ~ 13시 30분)</div>
                    </li>
                  </ul>
                </div>
                <div className={styles.footer__box}>
                  ...
                  <ul>
                    <li>
                      <span>무통장 계좌정보</span>
                      <div>우리은행 1005502842082 (주)다노</div>
                    </li>
                  </ul>
                </div>
                <div className={styles.footer__box}>
              ...
              >
                <div className={styles.footer__box}>
                  ...
                  <ul>
                    ...
                    <li className={styles["row-box"]}>
                      <span>사업장 주소</span>
                      <div>04038 서울특별시 마포구 월드컵북로 98, 2층 202</div>
                    </li>
                    <li className={styles["row-box"]}>
                      <div className={styles["row-box"]}>
                        <span>대표 전화</span>
                    ...
                    <li className={styles["row-box"]}>
                      ...
                      <div>제2017-서울마포-0722 [사업자정보확인]</div>
                    </li>
                    <li className={styles["row-box"]}>
                      <span>개인정보보호책임자</span>
                      <div>이지수</div>
        ...
        <div className="floating-nav__inner">
          <ul>
            ...
            <li>
              <Link
                to={
                  loggedIn === "member" ? "/mypage/dashboard" : "/member/login"
                }
