                          ...
                          <li>
                            <span className="radio-group">
                              <input
                                ...
                                checked={memberTypeValue === "personal"}
                              />
                          ...
                          <li>
                            <span className="radio-group">
                              <input
                                ...
                                name="memberType"
                                onChange={handleMemberType}
                                checked={memberTypeValue === "enterprise"}
                              />
                              <label htmlFor="enterprise">기업회원</label>
                            </span>
                          </li>
                        </ul>
                      </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {checkValidId && !isModifyPage ? (
                        <p className={checkValidId.class}>{checkValidId.msg}</p>
                      ) : null}
                    </td>
                  </tr>
                  <tr>
                        ...
                        <div className="birth-form__radio">
                          <span className="radio-group">
                            <input
                              ...
                              id="birthType1"
                              value={"birthType1"}
                              onChange={handleBirthValue}
                              checked={birthValue === "birthType1"}
                            />
